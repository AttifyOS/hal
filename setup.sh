...
install() {
  wget https://github.com/AttifyOS/hal/releases/download/v3.3.0-169/hal_v3.3.0-169-gd427c070be_amd64.snap -O $APM_TMP_DIR/hal_v3.3.0-169-gd427c070be_amd64.snap
